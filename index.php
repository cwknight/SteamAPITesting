...
<form method ="GET" action ="index.php">
    <input type="text" name="SteamVanityUrlInput" value ="<?php if(isset($_GET['SteamVanityUrlInput'])){echo $_GET['SteamVanityUrlInput'];}?>"/><br />
    <input type="submit" value="Submit" /><br />
    
</form>
<?php if(isset($_GET['SteamVanityUrlInput'])!= true)
      {
...
if(isset($_GET['SteamVanityUrlInput']))
{
    ...
    if($SteamUserInfoVar != false){
        ...
        #echo '<pre>',print_r($SteamGameListXML), '</pre>';
...
/*if(isset($_GET['SteamIDInput'])){
 
    $SteamID = $_GET['SteamIDInput'];
    $SteamUserInfoVar = simplexml_load_file($SteamUserInfoURL);
    
    echo $SteamUserInfoURL;
    print_r($SteamUserInfoVar);
}
*/
?>